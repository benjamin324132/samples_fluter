...
class BankAccount {
  ...
  static List<BankAccount> get accountCards => [
        ...
        BankAccount(
          ...
          const AccountTransaction('Next 30 July', 'HBO Max', -14.99, 'assets/bank_challenge/img/hbo-max-logo.webp'),
        ),
        //Second Account Card
        BankAccount(
          1460,
          ...
          const AccountTransaction('Next 06 August', 'Netflix', -12.99, 'assets/bank_challenge/img/netflix-logo.jpg'),
        ),
        //Third Account Card
        BankAccount(
          13230,
          ...
          const AccountTransaction('June 31', 'Deposit', 320.00, 'assets/bank_challenge/img/save-money.jpg'),
        ),
      ];
}
