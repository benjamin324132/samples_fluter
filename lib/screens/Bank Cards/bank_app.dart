...
class _BankCardState extends State<BankCard> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    _pageController = PageController(viewportFraction: .85, initialPage: 1)..addListener(_pageListener);
                      ...
                      Expanded(
                        ...
                        child: LayoutBuilder(builder: (context, constraints) {
                          ...
                          return Transform.translate(
                            offset: Offset(0, (constraints.maxHeight * 2) * value),
                            child: Stack(
                              children: [
                                //-------------------------------------
                                ...
                                //-------------------------------------
                                Transform.translate(
                                  offset: Offset(-widthBlueCard * (_blueBgTranslatePercent - 1), 0),
                                ...
                                //-------------------------------------
                                Transform(
                                  transform: Matrix4.identity()..translate(100.0 * (1 - _blueBgTransitionPercent)),
