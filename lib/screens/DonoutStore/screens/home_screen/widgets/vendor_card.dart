...
class VendorCard extends StatelessWidget {
  const VendorCard({Key? key, required this.imagePath, required this.name, required this.rating}) : super(key: key);
        ...
        children: [
          ...
          Column(
            ...
            children: <Widget>[
              Text(
                name,
                style: Theme.of(context).textTheme.headline5!.copyWith(fontSize: rf(16)),
              ),
