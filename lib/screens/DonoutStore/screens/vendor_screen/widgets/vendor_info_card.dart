...
class VendorInfoCard extends StatelessWidget {
  const VendorInfoCard({Key? key, required this.title, required this.rating, required this.sideImagePath})
      : super(key: key);
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    "$rating",
                    style: Theme.of(context).textTheme.headline6!.copyWith(fontSize: rf(12)),
                  ),
                  Text(
                    " • fast food • \$\$ • 15-20 min",
